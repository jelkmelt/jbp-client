...
import MultipleCitySelect from "@/components/CitySelect/MultipleCitySelect";
import SingleCitySelect from "@/components/CitySelect/SingleCitySelect";
import { usePostState } from "@/context/postContext/postState";
...
const SelectCity = () => {
  ...
  if (postType === "multiple cities") {
    return <MultipleCitySelect />;
  } else {
    return <SingleCitySelect />;
  }
};
